...
# Добавь явное ожидание для проверки перехода на страницу восстановлеия пароля
WebDriverWait(driver, 3).until(expected_conditions.visibility_of_element_located((By.XPATH, ".//div//h2[text() = 'Восстановление пароля']")))
